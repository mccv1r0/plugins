...
func validateCniContainerInterface(intf current.Interface, parentIndex int, vlanId int, mtu int) error {
	...
	//if parentIndex != vlan.Attrs().ParentIndex {
	//	return fmt.Errorf("Container vlan Master %d does not match expected value: %d", vlan.Attrs().ParentIndex, parentIndex)
	//}
